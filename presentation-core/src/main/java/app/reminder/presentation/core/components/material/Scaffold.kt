...
fun Scaffold(
    ...
    // Komikku: Handle consumed window insets
...
private fun ScaffoldLayout(
    ...
    SubcomposeLayout { constraints ->
        ...
        /**
         * Komikku: Remove height constraint for expanded app bar
         */
        ...
        layout(layoutWidth, layoutHeight) {
            ...
            // Komikku: Add startBar slot for Navigation Rail
            ...
            // Komikku: layoutWidth after horizontal insets
            ...
            // Komikku: Calculate insets for snackbar placement offset
            ...
            val fabPlacement = if (fabPlaceables.isNotEmpty() && fabWidth != 0 && fabHeight != 0) {
                ...
                // Komikku: Calculate insets for fab placement offset
            ...
            val bodyContentPlaceables = subcompose(ScaffoldLayoutContent.MainContent) {
                ...
                val innerPadding = PaddingValues(
                    ...
                    // Komikku: Also take account of fab height when providing inner padding
